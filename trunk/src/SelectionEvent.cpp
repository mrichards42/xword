...
DEFINE_EVENT_TYPE( wxEVT_XGRID_SELECTION )

XGridSelectionEvent::XGridSelectionEvent(
    int id, wxEventType type,
    XGridCtrl * grid, XSquare * start, XSquare * end)
    : wxEvent(id, type),
      m_grid(grid),
      m_start(start),
      m_end(end)
...
std::vector<XSquare *>
XGridSelectionEvent::GetSelection()
{
