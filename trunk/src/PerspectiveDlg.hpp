...
// Note that this should only be used as a modal dialog (because of wxSingleChoiceDialog)
class PerspectiveDialog
    : public wxSingleChoiceDialog
{
public:
    PerspectiveDialog(MyFrame * frame, const wxString & message, const wxString & caption, const wxArrayString & choices)
...
protected:
    ...
    MyFrame * m_frame; // hold this pointer so we can dynamically update the display
