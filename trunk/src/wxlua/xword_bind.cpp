...
static wxLuaArgType s_wxluatypeArray_wxLua_XGrid_SetupIteration[] = { &wxluatype_XGrid, NULL };
static int LUACALL wxLua_XGrid_SetupIteration(lua_State *L);
static wxLuaBindCFunc s_wxluafunc_wxLua_XGrid_SetupIteration[1] = {{ wxLua_XGrid_SetupIteration, WXLUAMETHOD_METHOD, 1, 1, s_wxluatypeArray_wxLua_XGrid_SetupIteration }};
//     void SetupIteration()
static int LUACALL wxLua_XGrid_SetupIteration(lua_State *L)
{
    // get this
...
wxLuaBindMethod XGrid_methods[] = {
    ...
    { "SetupIteration", WXLUAMETHOD_METHOD, s_wxluafunc_wxLua_XGrid_SetupIteration, 1, NULL },
