...
ifeq ($(config),debug)
  ...
  DEFINES   += -DLUA_LIB -DLUA_USE_LINUX -DLUATASK_PTHREAD_STACK_SIZE=2097152/16 -DLUATASK_API -DDEBUG -D_DEBUG -DLUA_USE_APICHECK
...
ifeq ($(config),release)
  ...
  TARGET     = $(TARGETDIR)/libtask.so
  DEFINES   += -DLUA_LIB -DLUA_USE_LINUX -DLUATASK_PTHREAD_STACK_SIZE=2097152/16 -DLUATASK_API -DNDEBUG
  INCLUDES  += -I../../lua/lua -I../../lua/lua/include
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
