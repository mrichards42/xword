...
local patterns,choose,function_arg,split = utils.patterns,utils.choose,utils.function_arg,utils.split
...
function query(data,condn,context,return_row)
    ...
    local fields = condn.proc_fields
    if return_row then
        fields = '{'..fields..'}'
    end
